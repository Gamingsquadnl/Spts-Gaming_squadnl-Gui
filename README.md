...
PlayerSection:NewButton("AntiAFK", "Roblox wont kick u", function()
...
_b.Size=UDim2.new(0,304,0,21)_b.Font=Enum.Font.Arial;_b.Text="Made by Gaming_squadnl"
...
PlayerSection:NewButton("GodMode", "Warning!! u cant shoot", function()
...
PlayerSection:NewButton("Comming soon", "idk yet", function()
    
end)


local Fun = Window:NewTab("Fun Stuff")
local FunSection = Fun:NewSection("Fun Stuff")


FunSection:NewButton("Comming soon", "idk yet", function()
